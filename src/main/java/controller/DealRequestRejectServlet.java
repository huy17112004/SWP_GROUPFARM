...
@WebServlet("/deal-requests/reject")
public class DealRequestRejectServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        DealConfirmDTO rejectDto = gson.fromJson(req.getReader(), DealConfirmDTO.class);

        // 2. Gọi service để xử lý
        DealRequestDTO updated = service.rejectDeal(rejectDto);
