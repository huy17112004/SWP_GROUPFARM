...
@WebServlet("/stock-transfers/export")
public class ExportStockTransferServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            StockTransferResponseDTO dto = stockTransferService.exportStockTransfer(stockTransferId);
            ...
            resp.getWriter().write(gson.toJson(new MessageResponse("Lỗi xử lý export!", false)));
        }
    }
}
